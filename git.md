...
[资料](https://www.cnblogs.com/AhuntSun-blog/p/12745183.html)
...
工作流其实不是一个初级主题，背后的本质问题是 有效的项目流程管理 和 高效的开发协同约定，而不仅仅是`Git`或`SVN`等[`VCS`](http://zh.wikipedia.org/wiki/版本控制)或[`SCM`](http://zh.wikipedia.org/wiki/软件配置管理)工具的使用。
...
[![Git Workflows](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/1.png)](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/1.png)

## 2.1 集中式工作流

如果你的开发团队成员已经很熟悉`Subversion`，集中式工作流让你无需去适应一个全新流程就可以体验`Git`带来的收益。这个工作流也可以作为向更`Git`风格工作流迁移的友好过渡。

[![Git Workflows: SVN-style](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/2.png)](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/2.png)
...
[![git-workflow-svn-push-local](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/3.png)](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/3.png)

### 2.1.2 冲突解决

中央仓库代表了正式项目，所以提交历史应该被尊重且是稳定不变的。如果开发者本地的提交历史和中央仓库有分歧，`Git`会拒绝`push`提交否则会覆盖已经在中央库的正式提交。

[![git-workflow-svn-managingconflicts](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/4.png)](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/4.png)
...
[![img](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/5.png)](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/5.png)
...
[![img](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/6.png)](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/6.png)
...
[![img](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/7.png)](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/7.png)
...
[![img](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/8.png)](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/8.png)
...
[![img](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/9.png)](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/9.png)
...
[![img](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/10.png)](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/10.png)
...
[![img](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/11.png)](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/11.png)
...
[![img](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/12.png)](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/12.png)
...
[![img](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/13.png)](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/13.png)
...
[![img](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/14.png)](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/14.png)
...
[![img](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/15.png)](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/15.png)
...
[![Git Workflows: Feature Branch](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/16.png)](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/16.png)

[![img](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/16.5.png)](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/16.5.png)

一旦你玩转了[集中式工作流](https://www.cnblogs.com/AhuntSun-blog/p/workflow-centralized.md)，在开发过程中可以很简单地加上功能分支，用来鼓励开发者之间协作和简化交流。

功能分支工作流背后的核心思路是所有的功能开发应该在一个专门的分支，而不是在`master`分支上。
这个隔离可以方便多个开发者在各自的功能上开发而不会弄乱主干代码。
另外，也保证了`master`分支的代码一定不会是有问题的，极大有利于集成环境。

功能开发隔离也让[`pull requests`工作流](https://www.cnblogs.com/AhuntSun-blog/p/pull-request.md)成功可能，
...
功能分支除了可以隔离功能的开发，也使得通过[`Pull Requests`](https://www.cnblogs.com/AhuntSun-blog/p/pull-request.md)讨论变更成为可能。
...
[![img](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/17.png)](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/17.png)
...
[![img](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/18.png)](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/18.png)
...
[![img](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/19.png)](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/19.png)
...
[![img](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/20.png)](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/20.png)

小黑收到了`Pull Request`后会查看`marys-feature`的修改。决定在合并到正式项目前是否要做些修改，且通过`Pull Request`和小红来回地讨论。

#### 小红再做修改

[![img](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/21.png)](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/21.png)
...
[![img](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/22.png)](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/22.png)
...
[![Git Workflows: Gitflow Cycle](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/23.png)](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/23.png)

这节介绍的[`Gitflow`工作流](http://nvie.com/posts/a-successful-git-branching-model/)借鉴自在[nvie](http://nvie.com/)的*Vincent Driessen*。

`Gitflow`工作流定义了一个围绕项目发布的严格分支模型。虽然比[功能分支工作流](https://www.cnblogs.com/AhuntSun-blog/p/workflow-feature-branch.md)复杂几分，但提供了用于一个健壮的用于管理大型项目的框架。
...
[![img](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/24.png)](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/24.png)
...
[![img](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/25.png)](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/25.png)

注意，从各种含义和目的上来看，功能分支加上`develop`分支就是功能分支工作流的用法。但`Gitflow`工作流没有在这里止步。

### 2.3.4 发布分支

[![img](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/26.png)](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/26.png)
...
[![img](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/27.png)](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/27.png)
...
[![img](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/28.png)](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/28.png)
...
[![img](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/29.png)](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/29.png)
...
[![img](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/30.png)](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/30.png)
...
冲突解决方法和[集中式工作流](https://www.cnblogs.com/AhuntSun-blog/p/workflow-centralized.md)一样。

#### 小红开始准备发布

[![img](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/31.png)](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/31.png)
...
[![img](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/32.png)](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/32.png)
...
[![img](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/33.png)](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/33.png)
...
到了这里，但愿你对[集中式工作流](https://www.cnblogs.com/AhuntSun-blog/p/workflow-centralized.md)、[功能分支工作流](https://www.cnblogs.com/AhuntSun-blog/p/workflow-feature-branch.md)和`Gitflow`工作流已经感觉很舒适了。
...
[![img](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/34.png)](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/34.png)
...
各个开发者应该用分支隔离各个功能，就像在[功能分支工作流](https://www.cnblogs.com/AhuntSun-blog/p/workflow-feature-branch.md)和[`Gitflow`工作流](https://www.cnblogs.com/AhuntSun-blog/p/workflow-forking.md)一样。
...
[![img](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/35.png)](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/35.png)
...
[![img](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/36.png)](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/36.png)
...
[![img](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/37.png)](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/37.png)
...
[![img](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/38.png)](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/38.png)
...
[![img](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/39.png)](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/39.png)
...
[![img](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/40.png)](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/40.png)
...
[![img](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/41.png)](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/41.png)
...
但不要害怕，这个工作流实际上就是在[功能分支工作流](https://www.cnblogs.com/AhuntSun-blog/p/workflow-feature-branch.md)之上引入另一个抽象层。
...
[![img](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/42.png)](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/42.png)
...
[![img](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/43.png)](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/43.png)
...
[![img](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/44.png)](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/44.png)
...
`Pull Request`可以和[功能分支工作流](https://www.cnblogs.com/AhuntSun-blog/p/workflow-feature-branch.md)、[`Gitflow`工作流](https://www.cnblogs.com/AhuntSun-blog/p/workflow-gitflow.md)或[`Forking`工作流](https://www.cnblogs.com/AhuntSun-blog/p/workflow-forking.md)一起使用。
但一个`Pull Request`要求要么分支不同要么仓库不同，所以不能用于[集中式工作流](https://www.cnblogs.com/AhuntSun-blog/p/workflow-centralized.md)。
...
[![img](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/45.png)](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/45.png)
...
[![img](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/46.png)](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/46.png)
...
[![img](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/47.png)](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/47.png)
...
[![img](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/48.png)](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/48.png)
...
[![img](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/49.png)](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/49.png)

小红先要`fork`小明的`Bitbucket`仓库，开始项目的开发。她登陆`Bitbucket`，浏览到小明的仓库页面，
点`Fork`按钮。

[![img](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/50.png)](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/50.png)

然后为`fork`出来的仓库填写名字和描述，这样小红就有了服务端的项目拷贝了。

#### 小红克隆她的`Bitbucket`仓库

[![img](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/51.png)](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/51.png)
...
[![img](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/52.png)](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/52.png)
...
[![img](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/53.png)](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/53.png)
...
[![img](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/54.png)](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/54.png)
...
[![img](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/55.png)](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/55.png)

创建好了`Pull Request`，通知会通过`Bitbucket`系统消息或邮件（可选）发给小明。

#### 小明review `Pull Request`

[![img](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/56.png)](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/56.png)
...
[![img](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/57.png)](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/57.png)
...
[![图片](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/58.png)](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/58.png)
...
[![img](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/59.jpg)](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/59.jpg)
...
[![img](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/60.jpg)](http://ahuntsun.gitee.io/blogimagebed/img/git/lesson11/60.jpg)
...
主分支： 通过脚手架创建项目时会自动生成git，所以git有很多方法生成，不固定

1. 创建远端仓库

2. 本地 git init    |  git clone 远端仓库

3. gitignore   (排除不上传的文件)
   add .  //本地缓存区

4. git commit -m '描述'        //本地仓库 初始版本

5. git remote add origin  https://gitee.com/uncle9/nz1901.git

   > 关联远程仓库 ,需要事先创建远端仓库(github|gitee|gitlab)
   > 远程仓库public 无需密码， private需要
   > public可以考虑克隆仓库后把下拉的项目文件中的.git赋值粘贴到项目脚手架生成的.git，这样项目的git就不需要与远程仓库连接了

6. git push -u origin master   //第一次提交远仓库
   git push 以后

```
        
        开发分支:
            1. git checkout -b 分支名(根据功能或人名起名字)      //有则切换，无则创建且切换,此时只是在本地创建了分支
               git branch //查看有哪些分支
            2. git checkout 分支名    //切换
               ..........开发........
            3. git add .   //本地缓存区    提交单个文件  git add ./src/aaa.js
            4. git commit -m '描述' //本地仓库
            5. git push origin 分支名  //上传本地分支到远端分支    分支名，远端有这个分支就上传，没有就创建并上传

组员:  永远不要在主分支上写代码(不要提交到主分支)

   1.  git clone 项目地址(主分支|开发分支)     clone似乎默认clone的就是主分支，需要后期转换
   				之后： git checkout -b 分支名(功能,人名)  这里代码跟第3点一摸一样，应该可以省略不用写
                git pull origin 分支|开发分       //之后拉取最新
   2.  cd 项目
   3.  git checkout -b 分支名   // 创建自己的开发分支  如果组长给了分支，可以省略
       ........开发..........
       git pull origin 分支 拉取指定分支的最新代码
   4.  git add .
...
合并代码工作 (组长|组员)
   ...
   下拉代码会出现提示( 保持当前(本地) | 应用最新(下拉的) | 都保留 | 比较√ )
...
版本回滚
    ...
    git push origin HEAD --force   推送本地到远程仓库 强推老代替新
    git reflog 查看命令操作的历史

单文件版本回滚
    git log fileName    查看单个文件的修改记录
...
.gitignore 文件中的  #  表示注释     ./idea 忽略当前目录下的idea文件夹